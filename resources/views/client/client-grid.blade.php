                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('student/list') }}">Client</a></li>
                                                ...
                                                <div class="student-box flex-fill">
                                                    <div class="student-img">
                                                        <a href="{{ url('client/profile/'.$list->id) }}">
                                                            <img class="img-fluid" alt="Students Info" src="{{ Storage::url('/clients/'.$list->upload) }}" width="20%" height="20%">
                                                        </a>
                                                    </div>
                                                    <div class="student-content pb-0">
                                                        <h5><a href="{{ url('client/profile/'.$list->id) }}">{{ $list->full_name }}</a></h5>
                                                        <h6>Student</h6>
                                                    </div>
                                                </div>
                                            </div>
